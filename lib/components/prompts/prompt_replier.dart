    ...
    return Column(
      children: [
        ...
        AppStreamBuilder(
          ...
          loader: widget.prompt.myReply == null
              ? null
              : MyReplyRow(myReply: widget.prompt.myReply!),
...
class MyReplyRow extends StatelessWidget {
  const MyReplyRow({Key? key, required this.myReply}) : super(key: key);
          ...
          children: [
            SizedBox(
              ...
              child: ProfilePicture(
                profile: myReply.owner,
                profileAsync: myReply.ownerAsync,
              ),
            ),
